      ...
      <ModalOverlay>
        <ModalCenter>
          <FlexDiv>
            <Subtitle>
              {modalType === 'stake'
                ? `Stake ${tokenASymbol} - ${tokenBSymbol} LP`
                : `Withdraw ${tokenASymbol} - ${tokenBSymbol} LP`}
            </Subtitle>
          ...
          <FlexDiv>
            ...
            <Button
              onClick={
                modalType === 'stake' ? () => setModalAmount(lpAvailable) : () => setModalAmount(depositedAmount)
              }
            >
              Max
            </Button>
          ...
          <FlexDiv>
            ...
            <Button onClick={modalType === 'stake' ? () => stake(modalAmount) : () => withdraw(modalAmount)}>
              Confirm
            </Button>
          </FlexDiv>
        </ModalCenter>
...
const PoolCard = (props) => {
  ...
  const {
    ...
    claim,
    setModalType,
  } = usePool({ poolAddress, tokenAAddress, tokenBAddress, lpAddress, rewardAddress })
    ...
    <>
      <Card>
        <FlexDiv>
          ...
          <Link href={`https://testnet.bscscan.com/address/${poolAddress}`} target="_blank">
            (BSCScan)
          </Link>
        </FlexDiv>
        <FlexDiv>
          <Text>APR: </Text>
          <Subtitle style={{ color: 'green' }}>n/a</Subtitle>
        </FlexDiv>
        <FlexDiv>
          <Text>Earn: </Text>
...
export default function Pool() {
  ...
  return (
    <>
      <H1>Farms</H1>
      <Cards>{renderPoolCards(pools)}</Cards>
    </>
  )
}
